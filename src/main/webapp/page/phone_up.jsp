...
<!--body wrapper start-->
  ...
  <%--  <c:forEach items="${sessionScope.all}" var="a">
    <select name="comm_class_id" id="comm_class_id">
        <option value="${a.class_id}">${a.claa_name}</option>
    </select>
    </c:forEach>
    <select id="comm_typeid" name="comm_typeid">
...
<form action="/phone/up.do" method="post" enctype="multipart/form-data">
        <div class="col-md-9" >
