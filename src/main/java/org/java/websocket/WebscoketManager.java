...
public class WebscoketManager {
    ...
    public void onOpen(Session session) {
        ...
        webSocketSet.put(this, httpSession.getAttribute("loginMan"));//加入set中
        System.out.println(webSocketSet.get(this));
        addOnlineCount();
        //在线数加
    ...
    public void sendMessage(String message) throws IOException {
        ...
        msg.put("userinfo", this.httpSession.getAttribute("loginMan"));
